...
vcom -93 -work work {./bbb2nes_testbench.vhd}
...
add wave -label pi_ce_n     sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/pi_ce_n
add wave -label pi_oe_n     sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/pi_oe_n
add wave -label pi_push_n   sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/pi_push_n
add wave -label pi_pop_n    sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/pi_pop_n
add wave -label pi_data     -radix hex  sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/pi_data
add wave -label po_data     -radix hex  sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/po_data
add wave -label po_stat_empty   sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/po_stat_empty
add wave -label po_stat_full    sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/po_stat_full
add wave -label reg_fifo_size    -radix unsigned        sim:/nes2bbb_testbench/sim_board/rd_fifo_inst/reg_fifo_size
